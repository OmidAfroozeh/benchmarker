...
def main():
    ...
    config: RunConfig = {
        ...
        'systems': [DUCK_DB_USSR_stable_version_operator_bttr_strs_col_seg, DUCK_DB_USSR_stable_version_operator_bttr_strs_flattening, DUCK_DB_MAIN, DUCK_DB_USSR_stable_version_operator],
